...
namespace assignment {
  ...
  int median_of_three(const std::vector<int>& arr, int start, int stop) {
    ...
    return first_not_max < second_not_max? second_not_max:first_not_max /* раньше здесь было что-то не так ... */;
  }
  ...
  int partition(std::vector<int>& arr, int start, int stop, int pivot) {
    ...
    return curr_pivot_index /* раньше здесь было что-то не так ... */;
  }
